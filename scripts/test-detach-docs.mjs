// Test: detach archives docs, attach un-archives them
...
async function main() {
  ...
  console.log("\n=== Step 1: ensure folder-a is attached to 汇集1 ===");
  ...
  console.log("\n=== Step 2: detach folder-a from 汇集1 (orphan — should archive docs) ===");
  const r2 = await detach(HUIJI1, FOLDER_A);
  console.log("  detach:", JSON.stringify(r2));
  s = state();
  console.log("Folders:"); console.log(showFolders(s.folders));
  console.log("Docs:"); console.log(showDocs(s.docs));
  console.log("Stats 汇集1:", JSON.stringify(await getStats()));

  console.log("\n=== Step 3: re-attach folder-a to 汇集1 (should un-archive) ===");
  const r3 = await attach(HUIJI1, FOLDER_A);
  console.log("  attach:", JSON.stringify(r3));
  s = state();
  console.log("Folders:"); console.log(showFolders(s.folders));
  console.log("Docs:"); console.log(showDocs(s.docs));
  console.log("Stats 汇集1:", JSON.stringify(await getStats()));
